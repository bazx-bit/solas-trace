"""Tmux session management: create, attach, and control tmux sessions for Solas Trace."""
...
class TmuxSession:
    ...
    def reattach_existing(self) -> bool:
        if not self.is_running():
            return False
        result = input(
            "\nA Solas Trace development environment is already running. Would you like to re-attach? (y/N) "
        )
