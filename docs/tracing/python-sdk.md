...
Welcome to the Solas Trace documentation for **Python Sdk**.
...
tracing::debug!("Processing Python Sdk request via Axum router");
```

*(Note: Detailed configuration parameters for Python Sdk will be expanded in future releases.)*
