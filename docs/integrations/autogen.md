...
Welcome to the Solas Trace documentation for **Autogen**.
...
tracing::debug!("Processing Autogen request via Axum router");
```

*(Note: Detailed configuration parameters for Autogen will be expanded in future releases.)*
