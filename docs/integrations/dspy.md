...
Welcome to the Solas Trace documentation for **Dspy**.
...
tracing::debug!("Processing Dspy request via Axum router");
```

*(Note: Detailed configuration parameters for Dspy will be expanded in future releases.)*
