...
Welcome to the Solas Trace documentation for **Openai Agents Sdk**.
...
tracing::debug!("Processing Openai Agents Sdk request via Axum router");
```

*(Note: Detailed configuration parameters for Openai Agents Sdk will be expanded in future releases.)*
