...
Welcome to the Solas Trace documentation for **Vercel Ai**.
...
tracing::debug!("Processing Vercel Ai request via Axum router");
```

*(Note: Detailed configuration parameters for Vercel Ai will be expanded in future releases.)*
