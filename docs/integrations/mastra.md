...
Welcome to the Solas Trace documentation for **Mastra**.
...
tracing::debug!("Processing Mastra request via Axum router");
```

*(Note: Detailed configuration parameters for Mastra will be expanded in future releases.)*
