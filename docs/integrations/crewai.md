...
Welcome to the Solas Trace documentation for **Crewai**.
...
tracing::debug!("Processing Crewai request via Axum router");
```

*(Note: Detailed configuration parameters for Crewai will be expanded in future releases.)*
