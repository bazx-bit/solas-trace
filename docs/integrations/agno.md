...
Welcome to the Solas Trace documentation for **Agno**.
...
tracing::debug!("Processing Agno request via Axum router");
```

*(Note: Detailed configuration parameters for Agno will be expanded in future releases.)*
