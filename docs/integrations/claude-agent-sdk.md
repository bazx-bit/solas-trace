...
Welcome to the Solas Trace documentation for **Claude Agent Sdk**.
...
tracing::debug!("Processing Claude Agent Sdk request via Axum router");
```

*(Note: Detailed configuration parameters for Claude Agent Sdk will be expanded in future releases.)*
