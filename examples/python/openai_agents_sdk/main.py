"""
Solas Trace Openai Agents Sdk Example.
...
def run_agent_flow():
    ...
    print(f"[OPENAI_AGENTS_SDK] Starting workflow... Trace: {trace_id}")
            ...
            "scopeSpans": [{
                "spans": [{
                    ...
                    "attributes": [
                        ...
                        {"key": "framework", "value": {"stringValue": "openai_agents_sdk"}},
    ...
    try:
        ...
        print(f"[OPENAI_AGENTS_SDK] Telemetry exported successfully to Solas Trace dashboard!")
    except Exception as e:
        print(f"[OPENAI_AGENTS_SDK] Telemetry export bypassed: {e}")
