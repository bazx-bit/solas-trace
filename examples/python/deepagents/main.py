"""
Solas Trace Deepagents Example.
...
def run_agent_flow():
    ...
    print(f"[DEEPAGENTS] Starting workflow... Trace: {trace_id}")
            ...
            "scopeSpans": [{
                "spans": [{
                    ...
                    "attributes": [
                        ...
                        {"key": "framework", "value": {"stringValue": "deepagents"}},
    ...
    try:
        ...
        print(f"[DEEPAGENTS] Telemetry exported successfully to Solas Trace dashboard!")
    except Exception as e:
        print(f"[DEEPAGENTS] Telemetry export bypassed: {e}")
