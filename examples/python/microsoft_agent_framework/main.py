"""
Solas Trace Microsoft Agent Framework Example.
...
def run_agent_flow():
    ...
    print(f"[MICROSOFT_AGENT_FRAMEWORK] Starting workflow... Trace: {trace_id}")
    ...
    try:
        ...
        print(f"[MICROSOFT_AGENT_FRAMEWORK] Telemetry exported successfully to Solas Trace dashboard!")
    except Exception as e:
        print(f"[MICROSOFT_AGENT_FRAMEWORK] Telemetry export bypassed: {e}")
