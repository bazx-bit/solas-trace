"""
Solas Trace Claude Agent Sdk Example.
...
def run_agent_flow():
    ...
    print(f"[CLAUDE_AGENT_SDK] Starting workflow... Trace: {trace_id}")
    ...
    try:
        ...
        print(f"[CLAUDE_AGENT_SDK] Telemetry exported successfully to Solas Trace dashboard!")
    except Exception as e:
        print(f"[CLAUDE_AGENT_SDK] Telemetry export bypassed: {e}")
