"""
Solas Trace Crewai Agent Example.
...
def run_agent_flow():
    ...
    print(f"[CREWAI_AGENT] Starting workflow... Trace: {trace_id}")
            ...
            "scopeSpans": [{
                "spans": [{
                    ...
                    "attributes": [
                        ...
                        {"key": "framework", "value": {"stringValue": "crewai_agent"}},
    ...
    try:
        ...
        print(f"[CREWAI_AGENT] Telemetry exported successfully to Solas Trace dashboard!")
    except Exception as e:
        print(f"[CREWAI_AGENT] Telemetry export bypassed: {e}")
