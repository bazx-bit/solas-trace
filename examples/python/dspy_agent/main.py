"""
Solas Trace Dspy Agent Example.
...
def run_agent_flow():
    ...
    print(f"[DSPY_AGENT] Starting workflow... Trace: {trace_id}")
    ...
    try:
        ...
        print(f"[DSPY_AGENT] Telemetry exported successfully to Solas Trace dashboard!")
    except Exception as e:
        print(f"[DSPY_AGENT] Telemetry export bypassed: {e}")
